Проектная работа по теме "Миграция сети ДЦ со статического VXLAN на EVPN".
...
Настройка eBGP с помощью префикс листа, чтобы редистрибьютить loopback'и.
...
Лучше сразу настроить Symetric IRB для будущего масштабирования и для выхода во внешние сети, а также виртуальный MAC-адрес.
